...
def get_response_text(start_time_str, schedule_table):
    if start_time_str:
        ...
        for k, v in schedule_table.items():
            ...
            # morning
            if (start_time == 4) and (subject_start_time >= 12):
                continue
            # afternoon
            if (start_time == 12) and (subject_start_time < 12):
                continue
...
# entities = [{'start': 0, 'end': 8, 'text': 'sáng mai', 'value': {'to': '2020-06-04T12:00:00.000+07:00', 'from': '2020-06-04T12:00:00.000+07:00'}, 'confidence': 1.0, 'additional_info': {'values': [{'to': {'value': '2020-06-07T12:00:00.000+07:00', 'grain': 'hour'}, 'from': {'value': '2020-06-07T04:00:00.000+07:00', 'grain': 'hour'}, 'type': 'interval'}], 'to': {'value': '2020-06-07T12:00:00.000+07:00', 'grain': 'hour'}, 'from': {'value': '2020-06-07T04:00:00.000+07:00', 'grain': 'hour'}, 'type': 'interval'}, 'entity': 'time', 'extractor': 'DucklingHTTPExtractor'}]
